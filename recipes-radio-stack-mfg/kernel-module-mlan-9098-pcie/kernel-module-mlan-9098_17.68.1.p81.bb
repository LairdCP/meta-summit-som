...
SRC_URI = " \
        file://PCIE-WIFI-U16-X86-${PV}-MXM5X17277_V0V1-MGPL-src.tgz \
        file://PCIE-WIFI-U16-X86-${PV}-MXM5X17277_V0V1-mlan-src.tgz \
        "

S = "${WORKDIR}/PCIE-UAPSTA-UART-BT-9098-U16-X86-${PV}-17.26.1.p81-MXM5X17277_V0V1-MGPL/wlan_src"
